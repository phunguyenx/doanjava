...
import com.raven.form.FormTTNhanVien;
...
public class EmployeeHomeForm extends javax.swing.JFrame {
    ...
    public EmployeeHomeForm(String username) {
        initComponents();
        this.username = username;
        id_emp = EmployeeControl.getIdByUsername(username);
        jdateStart.setDate(java.sql.Timestamp.valueOf(LocalDateTime.now()));
        jdateEnd.setDate(java.sql.Timestamp.valueOf(LocalDateTime.now().plusDays(1)));
        getContentPane().setBackground(new Color(63, 109, 217));
        jTextField1.setBackground(new java.awt.Color(0, 0, 0, 1));
        ...
        String[] name = EmployeeControl.getNameByUsername(username).split(" ");
    ...
    private void initComponents() {
        ...
        sidepane.add(btn_khachhang, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 230, 260, 40));
        ...
        jLabel80.setIcon(new javax.swing.ImageIcon(getClass().getResource("/mages/thongke.png"))); // NOI18N
        ...
        sidepane.add(btn_changepass, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 310, -1, 40));
        ...
        sidepane.add(btn_tk, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 270, -1, 40));
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        Bill bill = BillControl.Checkout(s, roomNumber, id_emp);
        if (bill != null) {
    ...
    private void btn_tkMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btn_tkMouseClicked
        // TODO add your handling code here:
        FormTTNhanVien f = new FormTTNhanVien(username);
        f.show();
